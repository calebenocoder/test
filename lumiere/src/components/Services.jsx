...
const services = [
  {
    number: '01',
    title: 'Er:YAG Laser',
    subtitle: 'LiteTouch Technology',
    description: 'Revolutionary erbium laser technology that enables virtually painless procedures with unmatched precision. The gold standard in minimally invasive dentistry.',
    features: ['Painless Treatment', 'No Anesthesia Required', 'Faster Healing', 'Maximum Precision'],
    icon: (
  ...
  },
  {
    ...
    description: 'State-of-the-art implant solutions using laser-guided placement for superior accuracy and integration. Natural-looking results that last a lifetime.',
    features: ['Laser-Guided Placement', 'Titanium Integration', 'Natural Aesthetics', 'Lifetime Durability'],
    icon: (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
  ...
  },
  {
    ...
    subtitle: 'Invisible Perfection',
    description: 'Custom-designed transparent aligners for discreet orthodontic treatment. Digitally planned for predictable, beautiful results.',
    features: ['Virtually Invisible', 'Custom 3D Design', 'Comfortable Fit', 'Predictable Results'],
    icon: (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
